...
//   // Fetch predictions
//   const fetchPredictions = async (steps) => {
//     try {
...
//   // Slider handler
//   const handleSlider = (e) => setPredictionSteps(parseInt(e.target.value));
...
//     saveAs(new Blob([csvContent], { type: 'text/csv;charset=utf-8' }), `vibration-${new Date().toISOString()}.csv`);
//   };
...
//     canvas.toBlob((blob) => {
//       saveAs(blob, `vibration-chart-${new Date().toISOString()}.png`);
//     });
//   };
...
//             <p>
//               {`Historical: ${data.historical.toFixed(3)} mm/s`}
//               {data.anomaly ? ' ⚠ Anomaly' : ''}
//             </p>
//           )}
//           {data.predicted !== null && <p>{`Predicted: ${data.predicted.toFixed(3)} mm/s`}</p>}
//         </div>
//       );
//     }
//     return null;
...
//   return (
//     <div>
//       <h2>Digital Twin - Wind Turbine Vibration</h2>
...
//               dataKey="historical"
//               stroke="#3b82f6"
//               dot={combinedData.map(d => d.anomaly ? { fill: 'red', r: 4 } : { r: 2 })}
//               name="Historical"
//             />
//             <Line
//               type="monotone"
...
//         <label>Prediction Steps: {predictionSteps}</label>
//         <input type="range" min="5" max="50" value={predictionSteps} onChange={handleSlider} />
//       </div>

//       <div style={{ marginTop: 10 }}>
//         <button onClick={exportCSV}>Export CSV</button>
//         <button onClick={exportPNG} style={{ marginLeft: 10 }}>Export PNG</button>
//       </div>
//     </div>
//   );
// }
            ...
            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-red-600 mt-2">
                  Make sure your backend server is running on {API_BASE_URL}. Currently showing demo data.
                </p>
              </div>
            </div>
          )}
